...
from blog.forms import CreatePostForm, RegisterForm, LoginForm, CommentForm
...
# CONNECT TO DB
# use blog.db before using remote database
...
# a webpage that talks about me
@app.route("/about")
def about():
    return render_template("about.html")

# a webpage to contact writer
@app.route("/contact")
def contact():
